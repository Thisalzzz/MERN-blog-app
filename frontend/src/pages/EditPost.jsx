            ...
            <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4' action="">
                ...
                <div className='flex flex-col'>
                    <div className='flex items-center space-x-4 md:space-x-8'>
                        <input value={cat} onChange={(e)=>setCat(e.target.value)} className='px-4 py-2 outline-none' type="text" placeholder='Enter post category'/>
                ...
                <textarea onChange={(e)=>setDesc(e.target.value)} value={desc} name="" id="" cols={30} rows={10} className='px-4 py-2 outline-none' placeholder='Enter post description'>
                </textarea>
